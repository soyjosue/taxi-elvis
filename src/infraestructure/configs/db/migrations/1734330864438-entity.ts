...
export class Entity1734330864438 implements MigrationInterface {
  name = 'Entity1734330864438';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "passengers" DROP CONSTRAINT "FK_6126a65a949ff19f3b697f44be7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "invoices" DROP CONSTRAINT "FK_829f1794155ac603a00fc753f30"`,
    );
    await queryRunner.query(
      `ALTER TABLE "drivers" DROP CONSTRAINT "FK_bffacbd6aa6409e21c2e63e9930"`,
    );
